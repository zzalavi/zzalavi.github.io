...
function renderWorld(oncomplete){
    ...
    for (let i = 0; i<3; i++){
        let c1 = dropUnit(ground_bricks[1], GRAPHICS.coin, i*32,-10);
		collidables.push(c1);
		coins.push(c1);
	}
    
    for (let i = 0; i<3; i++){
        let c1 = dropUnit(ground_bricks[2], GRAPHICS.coin, i*32,-10);
		collidables.push(c1);
		coins.push(c1);
    }
    for (let i = 0; i<3; i++){
        let c1 = dropUnit(ground_bricks[3], GRAPHICS.coin, i*32,-10);
		collidables.push(c1);
		coins.push(c1);
	}

    for (let i = 0; i<3; i++){
        let c1 = dropUnit(ground_bricks[4], GRAPHICS.coin, i*32,-10);
		collidables.push(c1);
		coins.push(c1);
    }
    
    for (let i = 0; i<3; i++){
        let c1 = dropUnit(ground_bricks[5], GRAPHICS.coin, i*32,-10);
		collidables.push(c1);
		coins.push(c1);
    }
    for (let i = 0; i<3; i++){
        let c1 = dropUnit(ground_bricks[6], GRAPHICS.coin, i*32,-10);
		collidables.push(c1);
		coins.push(c1);
    }
    for (let i = 0; i<3; i++){
    ...
    for (let i = 0; i<4; i++){
        let c1 = dropUnit(ground_bricks[8], GRAPHICS.coin, i*32+5, -100-i*32);
		collidables.push(c1);
		coins.push(c1);
    }
    for (let i = 0; i<4; i++){
        let c1 = dropUnit(ground_bricks[9], GRAPHICS.coin, i*32+5, -100-i*32);
		collidables.push(c1);
		coins.push(c1);
    }
    for (let i = 0; i<4; i++){
        let c1 = dropUnit(ground_bricks[1], GRAPHICS.coin, i*32+5, -100-i*32);
		collidables.push(c1);
		coins.push(c1);
    }
    for (let i = 0; i<4; i++){
        let c1 = dropUnit(ground_bricks[2], GRAPHICS.coin, i*32+5, -100-i*32);
		collidables.push(c1);
		coins.push(c1);
    }
    for (let i = 0; i<4; i++){
        let c1 = dropUnit(ground_bricks[3], GRAPHICS.coin, i*32+5, -100-i*32);
		collidables.push(c1);
		coins.push(c1);
    }
    for (let i = 0; i<4; i++){
        let c1 = dropUnit(ground_bricks[4], GRAPHICS.coin, i*32+5, -100-i*32);
		collidables.push(c1);
		coins.push(c1);
    }
    for (let i = 0; i<4; i++){
        let c1 = dropUnit(ground_bricks[5], GRAPHICS.coin, i*32+5, -100-i*32);
		collidables.push(c1);
		coins.push(c1);
    }
    for (let i = 0; i<4; i++){
    ...
    for (let i = 0; i<3; i++){
        let c1 = dropUnit(ground_bricks[20], GRAPHICS.coin, i*32, -232);
		collidables.push(c1);
		coins.push(c1);
	}
