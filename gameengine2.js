...
function renderWorld(oncomplete){
    ...
    for (let i = 1; i<4; i++){
        if (i === i) {
			bb1 = dropUnit(ground_bricks[1], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
			bb1 = dropUnit(ground_bricks[2], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
			bb1 = dropUnit(ground_bricks[3], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
			bb1 = dropUnit(ground_bricks[4], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
		}
        if (i === i) {
			bb1 = dropUnit(ground_bricks[5], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
			bb1 = dropUnit(ground_bricks[6], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
			bb1 = dropUnit(ground_bricks[7], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
			bb1 = dropUnit(ground_bricks[8], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
			bb1 = dropUnit(ground_bricks[9], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
			bb1 = dropUnit(ground_bricks[10], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
			bb1 = dropUnit(ground_bricks[11], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
			bb1 = dropUnit(ground_bricks[12], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
			bb1 = dropUnit(ground_bricks[13], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
			bb1 = dropUnit(ground_bricks[14], GRAPHICS.question_block,i*32,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
        }
        if (i === i) {
        ...
        if (i === i) {
			bb1 = dropUnit(ground_bricks[15], GRAPHICS.question_block,i*12,-i*32);
			hitables.push(bb1);
		collidables.push(bb1);
		}
        if (i === i) {
